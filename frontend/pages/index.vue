    ...
    <main class="main">
        ...
        <div class="container">
            ...
            <div class="marketPage__filters">
                ...
                <div class="dropdownFilter__name">Сортировать по:</div>
                <div class="select">
                    <div class="select__value">Цена по возрастанию</div>
                ...
                <div class="dropdownFilter">
                <div class="dropdownFilter__name">Материал</div>
                <div class="select">
                    <div class="select__value">Цена по возрастанию</div>
                    <ul class="select__items">
                    <li class="select__item">Цена по возрастанию</li>
            ...
            <div class="marketPage__products">
                ...
                <div class="productItem__tag">Скидка</div>
                <img
                ...
                <div class="productItem__info">
                    <div class="productItem__infoCode">L422WH</div>
                    <div class="productItem__infoName">Ручка дверная</div>
                    <div class="productItem__infoOther">
                    <div class="productItem__infoPrice">
                        <div class="productItem__infoPrice_old">136₽</div>
                        <div class="productItem__infoPrice_current">99₽</div>
                    </div>
                    <div class="productItem__infoActions">
                        <div class="productItem__infoAction productItem__infoAdd">
                        <svg
                            width="36"
                            height="36"
                            viewBox="0 0 36 36"
                        ...
                        <div class="productItem__infoAction productItem__infoLike">
                        <svg
                            width="36"
                            height="36"
                            viewBox="0 0 36 36"
